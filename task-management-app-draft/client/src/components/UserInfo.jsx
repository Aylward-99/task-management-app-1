    ...
    <div className='px-4'>
        ...
        >
            ...
            <div className='flex items-center gap-4 rounded-lg shadow-lg bg-white p-8'>
                <div className='w-16 h-16 bg-blue-500 rounded-full text-white flex items-center justify-center text-2xl '>
                ...
                <div className='flex flex-col gap-y-1'>
                    ...
                    <span className='text-base text-gray-400'>{user?.title}</span>
